...
typedef enum _itemDef {
	...
	//총 : ITEM_GUN
	ITEM_GUN_PISTOL = 0,//1//발화식 총
	ITEM_GUN_DERRINGER,//2//더블 데린저
	ITEM_GUN_FLINT_PINCHER,//3//포켓 플린처
	ITEM_GUN_REVOLVER,//4//리볼버 파이슨
	ITEM_GUN_PEACEMAKER,//5//피스메이커
	ITEM_GUN_HUNTING_MAGNUM,//6//헌팅 매그넘
	ITEM_GUN_MAGNUM,//7//45구경 오토건
	ITEM_GUN_DUAL_TRIGGER,//8//듀얼 트리거
	ITEM_GUN_SAWED_OFF,//9//소드오프 샷건
	ITEM_GUN_AUTOGUN45MM,//10//고져스 건
	ITEM_GUN_ROYAL_MUSKET,//11//로열 머스킷
	ITEM_GUN_DUELLING,//12//듀얼링 플린트
	ITEM_GUN_JEWELGUN,//13//회천마도총
	ITEM_GUN_FROST_RAY,//14//프로스트 레이
	ITEM_GUN_VOLTIC_BLASTER,//15//볼틱 블래스터
	ITEM_GUN_EXPLOSION,//16//태양의 총
	ITEM_GUN_ECLIPSE_RIFLE,//17//이클립스 라이플
	ITEM_GUN_LUMINOUS_CANNON,//18//루미너스 캐넌
	ITEM_GUN_CROSSFIRE,//19//헬파이어 건
	ITEM_GUN_ABYSS_BAZOOKA,//20//아비스 바주카
	ITEM_GUN_BEHEMOTH_LAUNCHER,//21//베히모스 런처
	ITEM_GUN_INFERNO,//22//크로스 파이어
	ITEM_GUN_TESTAMENT,//23//테스타먼트
	ITEM_GUN_RAGNAROK,//24//라그나로크
	ITEM_GUN_DRAGON_BREATH,//25//드래곤 브레스
	ITEM_GUN_APOCALYPSE,//26//묵시록의 나팔
	ITEM_GUN_LEVIATHAN,//27//레비아탄 하푼
	ITEM_GUN_VALKYRIE,//28//발키리 레일건
	ITEM_GUN_HADES,//29//하데스 익스큐셔너
	ITEM_GUN_DIMENSION,//30//차원붕괴포
	ITEM_GUN_SUPERNOVA,//31//슈퍼노바 블래스터
	ITEM_GUN_JUDGMENT,//32//천상신의 징벌
	ITEM_GUN_ASTRAL,//33//아스트랄 블래스터
	ITEM_GUN_SINGULARITY,//34//인피니티 싱귤래리티
	ITEM_GUN_GODSLAYER,//35//신살자의 총
	TOTAL_GUN,

	//부메랑 : ITEM_BOOMERANG (35종)
	ITEM_BOOMERANG_BOOMERANG = 0,//0//사냥용 부메랑 (원래 1)
	ITEM_BOOMERANG_BONE,//1//본 부메랑
	ITEM_BOOMERANG_FLINT,//2//플린트 크레센트
	ITEM_BOOMERANG_VOYAGER,//3//슬라이서 (원래 2)
	ITEM_BOOMERANG_WINDCUTTER,//4//윈드 커터
	ITEM_BOOMERANG_FALCON,//5//팔콘 윙
	ITEM_BOOMERANG_WINDWALKER,//6//강철 부메랑 (원래 3)
	ITEM_BOOMERANG_CROSSBLADE,//7//크로스 블레이드
	ITEM_BOOMERANG_BARBEDFANG,//8//바브드 팽
	ITEM_BOOMERANG_DOUBLECROSS,//9//트라이 엣지 (원래 4)
	ITEM_BOOMERANG_SHADOWCHAKRAM,//10//쉐도우 차크람
	ITEM_BOOMERANG_FLAMEWING,//11//플레임 윙
	ITEM_BOOMERANG_THUNDERMASTER,//12//라이트닝 엣지 (원래 5)
	ITEM_BOOMERANG_FROSTFANG,//13//프로스트 팽
	ITEM_BOOMERANG_VENOMSPIKE,//14//베놈 스파이크
	ITEM_BOOMERANG_SOULCHASER,//15//소울 체이서 (원래 6)
	ITEM_BOOMERANG_BLOODREAPER,//16//블러드 리퍼
	ITEM_BOOMERANG_MYSTICRUNE,//17//미스틱 룬
	ITEM_BOOMERANG_GRYPHONWING,//18//그리폰 윙 (원래 7)
	ITEM_BOOMERANG_PHOENIXTAIL,//19//피닉스 테일
	ITEM_BOOMERANG_DRAGONCREST,//20//드래곤 크레스트
	ITEM_BOOMERANG_MEGATRIAL,//21//로커스트 헌트 (원래 8)
	ITEM_BOOMERANG_CHAOSSPIRAL,//22//카오스 스파이럴
	ITEM_BOOMERANG_TITANBREAKER,//23//타이탄 브레이커
	ITEM_BOOMERANG_VALKYRIE,//24//발키리 크레센트
	ITEM_BOOMERANG_VOIDVORTEX,//25//보이드 소용돌이
	ITEM_BOOMERANG_SOLARFLARE,//26//솔라 플레어
	ITEM_BOOMERANG_LUNARECLIPSE,//27//루나 이클립스
	ITEM_BOOMERANG_TEMPESTSTORM,//28//템페스트 스톰
	ITEM_BOOMERANG_ABYSSUS,//29//아비수스 리퍼
	ITEM_BOOMERANG_SERAPHIMWING,//30//세라핌 윙
	ITEM_BOOMERANG_GENESISCROSS,//31//제네시스 크로스
	ITEM_BOOMERANG_ARMAGEDDON,//32//아마게돈 엣지
	ITEM_BOOMERANG_CHRONOSSPIRE,//33//크로노스 스피어
	ITEM_BOOMERANG_DEUS_EX_MACHINA,//34//데우스 엑스 마키나
	TOTAL_BOOMERANG,
