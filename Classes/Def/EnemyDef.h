...
typedef enum _enemyDef {
	...
	ENEMY_TREE,	//?�의 주인 4
	ENEMY_ONEEYE,	//?�이�?5
	ENEMY_SKELETON,	//칠흑??기사 6 
	ENEMY_LIZARD,	//?�하�?병사 7
	ENEMY_JELLYFISH,	//맹독 ?�파�?
	ENEMY_KNIGHT,	//?�?�한 기사 9
	ENEMY_SLIME,	//?�라??10
	ENEMY_SLING,	//?�원???�적 11
	ENEMY_BOAR,	//거친�?멧돼지 12
	ENEMY_FLAME,	//분노???�령 13
	ENEMY_PHOENIX,	//마성??불새14
	ENEMY_FACE,	//결빙???�상15
	ENEMY_SNOWMAN,	//?�노?�맨16
	ENEMY_ICESUN,	//?�이?�마?�크17
	ENEMY_LIGHTNING,	//?�파??8//
	ENEMY_THUNDER,	//?�크미스??9 //버그 : (?�환???�동???�함.
	ENEMY_CRYSTAL,	//?�파???�랜??0 //버그 : (?�환???�성???�파?��? ?�군??공격??
	ENEMY_FAIRY,	//?�이???�피�?1 //버그 : (?�환?? ?��? 공격??
	ENEMY_CIRCLE,	//?�루???�울22
	ENEMY_SPIDER,	//?�트?�이??3 //버그 : (?�환?? ?�이?��??�쏨 ?��? ?�그?�짐
	ENEMY_GOLEM,	//주인?��? 골렘24
