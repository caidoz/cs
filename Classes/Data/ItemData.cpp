...
static const int itemValueTypeText_builtin[] = {
	...
	//부위가 하는 일이 바뀌었다(Func_Combat.cpp 의 RefreshStat).
	//투구/갑옷은 방어, 장갑은 공격, 허리/신발은 체력이다. 전부 절대값이다.
	//여기와 저기 중 하나만 고치면 표기와 실제가 어긋난다.
	TEXT_ALPHA_DEFENSE,	//ITEM_HELM
	TEXT_ALPHA_DEFENSE,	//ITEM_HAT
	TEXT_ALPHA_DEFENSE,	//ITEM_CAP
	TEXT_ALPHA_DEFENSE,	//ITEM_ARMOR
	TEXT_ALPHA_DEFENSE,	//ITEM_VEST
	TEXT_ALPHA_DEFENSE,	//ITEM_COAT
	TEXT_ALPHA_DAMAGE,	//ITEM_GUNTLET
	TEXT_ALPHA_DAMAGE,	//ITEM_ARMLET
	TEXT_ALPHA_DAMAGE,	//ITEM_GLOVE
	TEXT_STAT_MAXHP,	//ITEM_KILT
	TEXT_STAT_MAXHP,	//ITEM_SKIRT
	TEXT_STAT_MAXHP,	//ITEM_PANTS
	TEXT_STAT_MAXHP,	//ITEM_GREAVES
	TEXT_STAT_MAXHP,	//ITEM_SHOES
	TEXT_STAT_MAXHP,	//ITEM_BOOTS
