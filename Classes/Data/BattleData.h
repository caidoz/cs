...
const short hitAlpha[] = {
    ALPHA_MISS,
    ALPHA_GOOD,
    ALPHA_GREAT,
};

const short raidAlpha[] = {
    ALPHA_GOOD,
    ALPHA_GREAT,
    ALPHA_PERFECT,
};
...
const unsigned short arenaOff[TOTALARENAOFF * 4] = {
...
const signed short arenaMI[90 * 4] = {
    //ARENA_START
...
const unsigned char arenaMIC[TOTALARENAMOTION * 2] = {
    0, 5,	//0
    5, 4,	//1
    9, 4,	//2
    13, 8,	//3
