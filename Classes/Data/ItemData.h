...
const unsigned short itemTypeCnt[TOTALITEMTYPE] = {
    TOTAL_SWORD,        //robin
    TOTAL_GUN,
    TOTAL_BOOMERANG,
    TOTAL_HELM,         //robin
...
const signed short newCardEffect[] = {
...
// ===== 개방된 아이템 초기값 =====
const unsigned short openedItemData[] = {
...
//장비레벨업 맥스값
const unsigned char itemLevelLimit[2 * TOTAL_SWORD] = {
	5, 0,//★
	5, 5,//★★
	5, 10,//★★★
	5, 15,//★★★★
...
const long long itemEvolutionItem[] = {
	//★
1,
2,
3,
...
const long long itemUpgradeHammer[] = {
	//★
1,
2,
3,
...
const unsigned short arenaFloorGold[] = {
	1,
	2,
	3,
	4,
...
const unsigned short revolutionMedal[] = {
	10,//★
	50,//★★
	100,//★★★
	300,//★★★★
...
const unsigned int itemColor[10] = {
...
const unsigned int buffBlend[16] = {
...
const unsigned char swordMaxBet[] = {
	5,//연습용 몽둥이
	5,//롱소드
	5,//처형자의 검
	5,//파멸의 참마도
...
const unsigned char swordHeart[] = {
...
const unsigned long long itemPrice[ITEM_QUEST_START] = {
	//검 : ITEM_SWORD				
...
const unsigned int itemSellPrice[301] = {
	//검 : ITEM_SWORD
...
const unsigned short itemStar[] = {
	...
	700,//ITEM_SWORD_ULTIMATE00,//31//얼티밋소드
	700,//ITEM_SWORD_DIMENSIONAL00,//32//차원의 검
	700,//ITEM_SWORD_HEAVEN00,//33//천공의 검
	700,//ITEM_SWORD_STARDUST00,//34//스타더스트
	700,//ITEM_SWORD_KING00,//35//패왕의 검
	//TOTAL_SWORD,
	...
	700,//ITEM_NECK2400,//토르테 악보(24)
	700,//ITEM_NECK2500,//용자의 시계(25)
	700,//ITEM_NECK2600,//악마의 뿔피리(26) X
	700,//ITEM_NECK2700,//아만디움 달걀(27) X
	//TOTAL_NECK,
	...
	100,//BOX_INGAME = 0,
	100,//BOX_EQUIP_WOOD,
	200,//BOX_EQUIP_SILVER,
	300,//BOX_EQUIP_GOLD,
	400,//BOX_EQUIP_MAGIC,
	500,//BOX_EQUIP_HERO,
	600,//BOX_EQUIP_LEGEND,
	400,//BOX_CREW_SEBASTIAN,
	500,//BOX_CREW_PRINCESS,
	600,//BOX_CREW_KING,
	700,//BOX_CREW_DEVIL,
	100,//BOX_ATTR_FIRE00,//아이템이 들어 있는 박스
	200,//BOX_ATTR_FROST,
	300,//BOX_ATTR_EARTH,
	400,//BOX_ATTR_THUNDER,
	500,//BOX_ATTR_LIGHT,
	600,//BOX_ATTR_DARK,
	//TOTAL_BOX,
...
const unsigned short itemStartCnt[TOTALITEMTYPE] = {
	ITEM_SWORD_START,
	ITEM_GUN_START,
...
const unsigned char boxEquipType[] = {
	ITEM_SWORD,//1
	ITEM_HELM,//2
	ITEM_ARMOR,//3
	ITEM_GUNTLET,//4
...
const unsigned char materialDropData[(NPC_CAPTAIN - 1) * 6] = {
...
const unsigned char wasteDropData[(NPC_CAPTAIN - 8) * TOTAL_WASTE] = {
...
const int itemValueType[ITEM_RING + 1] = {
...
const int itemValueTypeText[ITEM_RING + 1] = {
...
const unsigned char itemEquipSlot[ITEM_NECK] = {
...
const unsigned char itemSlotEquip[EQUIP_RING + 1] = {
...
const unsigned char wasteDrop[30] = {
	ITEM_WASTE_RETURN,
	ITEM_WASTE_RETURN,
	ITEM_WASTE_RETURN,
	ITEM_WASTE_RETURN,
...
const unsigned char wasteValue[7] = {
	0, 5, 20, 40, 3, 10, 30,
};
const unsigned char weaponRange[3] = {
	10,	//검
	20,	//총
	15,	//부메랑
};
...
const unsigned int itemValue[ITEM_NECK_START] = {
	//검 : ITEM_SWORD																																																																																																				
...
const unsigned char gradeRatio[] = {
	100, //GRADE_NORMAL
	100, //GRADE_SUPERIOR
	100, //GRADE_RARE
	100, //GRADE_SET
...
const unsigned char acceOptionStatMatch[6 * 2] = {
...
const unsigned int acceDefaultStatValue[6 * (ACCEMAXLEVEL)] = {
	//WEAPONDMG,
	5,
	10,
	15,
...
const unsigned int neckOptionStatValue[(TOTAL_NECK) * (ACCEMAXLEVEL)] = {
	//명예의 펜던트(적중)
...
const unsigned int ringOptionStatValue[(TOTAL_RING) * (ACCEMAXLEVEL)] = {
...
const unsigned int gemOptionStatValue[(TOTAL_GEM) * (ACCEMAXLEVEL)] = {
	//ITEM_GEM_RUBY,	//루비(46)
	//WEAPONDMG
	1,
	2,
...
//초기무기 - 공격력 : 7/5/10 요구레벨 : 1 요구스탯 : 1
const unsigned int itemUpgradeValue[] = {
...
const unsigned char itemRatio[TOTALEQUIP] = {
...
const unsigned short itemPow[220] = {
	10,
	11,
	12,
	13,
...
const unsigned char itemLv[ITEM_NECK * 8] = {
	//검
...
const unsigned char itemStat[ITEM_NECK * 8] = {
	//검
...
//반지		35:10
const unsigned int enchantData[ITEM_NECK * ENCHANTDATASIZE_TYPE * ENCHANTDATASIZE] = {
	//검 : ITEM_SWORD
...
const unsigned char itemCooltime[TOTAL_WASTE] = {
	10,	//귀환서
	10,	//별의 씨앗
	10,	//달의 씨앗
	10,	//태양의 씨앗
...
//아이템 종류-아이콘 매칭 테이블
const unsigned short itemIconTable[] = {
	//ITEM_SWORD
	64 * 3 + 24 + 0,//연습용 몽둥이
	64 * 3 + 24 + 1,//롱소드
	64 * 3 + 24 + 2,//처형자의 검
...
const unsigned int neckOption[NECKOPTIONDATASIZE * TOTAL_NECK] = {
	//명예의 펜던트(적중)
...
const signed int neckRingDefaultValue[] = {
	//WEAPONDMG,
	5,
	10,
	15,
...
const signed char ringOption[RINGOPTIONDATASIZE * TOTAL_RING] = {
	//0 : 0레벨의 기본값
	//1 : 1레벨당 증가값의 100배
	//2 : 지속시간(12프레임 단위)
...
const int optionRange[(SUFFIX_RESERVED3 + 1) * 6] = {
	//접두사
...
const signed char optionValue[SUFFIX_RESERVED3 + 1] = {
...
const unsigned char setItem[SETITEMDATASIZE * ITEM_GEM_START * 2] = {
	//0 : 세트 번호
	//1 : 옵션 첫번째
	//2 : 옵션 두번째
...
const int setOption[SETOPTIONDATASIZE * TOTALSET] = {
	//0 : 첫번째 세트효과가 나올 세트 수
	//1 : 세트효과 첫번째 옵션 종류
	//2 : 세트효과 첫번째 옵션 값
	//3 : 두번째 세트효과가 나올 세트 수
...
const unsigned int legendItem[LEGENDITEMDATASIZE * ITEM_NECK * 2] = {
	//--------- 검 ---------//
	//스타더스트
...
//옵션<->스탯 테이블
const signed char optionStat[TOTALITEMOPTION] = {
	//접두사 옵션
...
//옵션 테이블
const signed char option_prefix[16 * TOTALEQUIP] = {
	//EQUIP_WEAPON(14)
	PREFIX_WEAPON_DMG,
	PREFIX_SWORD_DMG,
	PREFIX_CRITICAL,
...
const signed char option_suffix[16 * TOTALEQUIP] = {
	//EQUIP_WEAPON(14)
	SUFFIX_WEAPON_DMG,
	SUFFIX_SWORD_DMG,
	SUFFIX_FIRE_ATTACK,
...
const unsigned char option_count_prefix[TOTALEQUIP] = {
	14,	//EQUIP_WEAPON
	16,	//EQUIP_HELM
	16,	//EQUIP_ARMOR
	16,	//EQUIP_PANTS
...
const unsigned char option_count_suffix[TOTALEQUIP] = {
	14,	//EQUIP_WEAPON
	16,	//EQUIP_HELM
	16,	//EQUIP_ARMOR
	16,	//EQUIP_PANTS
...
const unsigned char gemOption[TOTALGEMOPTION * 3] = {
...
//보석 장착 가격
const int gemPrice[6] = {
	10, 50, 100, 300, 500, 1000,
};


const int enchantRate[] = {
	//일반, 고급, 희귀, 세트, 영웅, 전설
	//0, 0, 0, 0, 0, 0,//0
...
const unsigned char extraSetItem[SETITEMDATASIZE * 96 * 2] = {
	//대원 동굴 장비
	//로빈 동굴 1 흐룬팅						
...
const signed int newItemReward[ITEM_NECK_START * REWARDITEMDATASIZE] = {
	//ITEM_SWORD,
