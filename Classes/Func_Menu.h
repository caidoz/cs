...
const signed int crewMenuUiData[] = {
	640, 153, 0, 0, 0, 0, MENU_CREW_IMG,//상단창
	
	332, 114, 641, 0, 154, 4, MENU_CREW_IMG,//타이틀 창
};

const signed int equipMenuUiData[] = {
	640, 149, 0, 154, 0, 0, MENU_CREW_IMG,//상단창

	290, 128, 641, 155, 176, 4, MENU_CREW_IMG,//타이틀 창

	//597, 326, 0, 543, 19, 130, MENU_EQUIP_IMG,//현재 캐릭터 셋업
};

const signed int shopMenuUiData[] = {
	640, 137, 0, 304, 0, 0, MENU_CREW_IMG,//상단창

	337, 114, 641, 305, 152, 16, MENU_CREW_IMG,//타이틀 창
};

const signed int castleMenuUiData[] = {
	640, 163, 0, 442, 0, -17, MENU_CREW_IMG,//상단창

	346, 112, 654, 453, 147, 12, MENU_CREW_IMG,//타이틀 창
};
